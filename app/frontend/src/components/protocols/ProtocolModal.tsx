...
export function ProtocolModal({ open, protocol, onClose, onSaved }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-2 sm:p-4">
      ...
      <div className="relative w-full max-w-md bg-white rounded-2xl shadow-xl animate-in fade-in slide-in-from-bottom-4 sm:zoom-in-95 duration-150 max-h-[92vh] overflow-y-auto">
